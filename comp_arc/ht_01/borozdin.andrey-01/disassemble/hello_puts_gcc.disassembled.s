...
bin/hello_puts_gcc:     file format elf32-i386
...
08048350 <deregister_tm_clones>:
 8048350:	b8 33 a0 04 08       	mov    $0x804a033,%eax
 8048355:	2d 30 a0 04 08       	sub    $0x804a030,%eax
 ...
 8048370:	c7 04 24 30 a0 04 08 	movl   $0x804a030,(%esp)
...
08048380 <register_tm_clones>:
 8048380:	b8 30 a0 04 08       	mov    $0x804a030,%eax
 8048385:	2d 30 a0 04 08       	sub    $0x804a030,%eax
 ...
 80483ad:	c7 04 24 30 a0 04 08 	movl   $0x804a030,(%esp)
...
080483c0 <__do_global_dtors_aux>:
 80483c0:	80 3d 30 a0 04 08 00 	cmpb   $0x0,0x804a030
 ...
 80483d4:	c6 05 30 a0 04 08 01 	movb   $0x1,0x804a030
 80483db:	c9                   	leave  
...
0804840c <main>:
 ...
 804840f:	68 20 a0 04 08       	push   $0x804a020
 8048414:	e8 d7 fe ff ff       	call   80482f0 <puts@plt>
 8048419:	89 ec                	mov    %ebp,%esp
 804841b:	5d                   	pop    %ebp
 804841c:	bb 03 00 00 00       	mov    $0x3,%ebx
 8048421:	b8 01 00 00 00       	mov    $0x1,%eax
